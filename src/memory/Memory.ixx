...
namespace Memory
{
	...
	auto ReadPhysical(const u32 physical_address)
	{
		/* use this switch-statement for now. function pointer table to come. */
		switch (physical_address >> 20)
		{
		case 0x000: case 0x001: case 0x002: case 0x003:
			return RDRAM::ReadStandardRegion<number_of_bytes>(physical_address);

		case 0x004: case 0x005: case 0x006: case 0x007:
			return RDRAM::ReadExpandedRegion<number_of_bytes>(physical_address);
